...
public class TestCases {
    ...
    public void test3() {
        ...
        String msg2 = "{\"messageId\": \"def\"}";
        messages.add(msg1);messages.add(msg2);
        Thread ProducerThread1 = TestUtil.producerThread(producer,messageQueue,messages,2);
        String msg3 = "{\"messageId\": \"xyz\"";
        messages1.add(msg3);
        Thread ProducerThread2 = TestUtil.producerThread(producer,messageQueue,messages1,2);
    ...
    public void test4() {
        ...
        Consumer consumer1 = new ConsumerImpl(messageQueue, "1",filter1);
        Thread consumerTh1 = TestUtil.consumerThread(consumer1);
        MessageFilter<Message<String>> filter2 = new HttpMessageFilter(400);
        Consumer consumer2 = new ConsumerImpl(messageQueue, "2",filter2);
        Thread consumerTh2 = TestUtil.consumerThread(consumer2);
